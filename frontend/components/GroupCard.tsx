...
export function GroupCard({
  ...
  // Calculate pool amount using formatEther for proper ETH handling
  const entryFeeWei = parseEther(group.entryFeeEth);
  const poolAmount = formatEther(
    entryFeeWei * BigInt(group.participants.length),
  );
